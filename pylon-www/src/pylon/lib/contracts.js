...
import PYLONJson from '../clean_build/contracts/PYLONDelegator.json';
import PYLONRebaserJson from '../clean_build/contracts/PYLONRebaser.json';
import PYLONReservesJson from '../clean_build/contracts/PYLONReserves.json';
import PYLONGovJson from '../clean_build/contracts/GovernorAlpha.json';
import PYLONTimelockJson from '../clean_build/contracts/Timelock.json';
...
// basic pool
import WETHPoolJson from '../clean_build/contracts/PYLONETHPool.json';
import YAMPoolJson from '../clean_build/contracts/PYLONYAMPool.json';
import YFIPoolJson from '../clean_build/contracts/PYLONYFIPool.json';
import YFIIPoolJson from '../clean_build/contracts/PYLONYFIIPool.json';
import MKRPoolJson from '../clean_build/contracts/PYLONMKRPool.json';
import LENDPoolJson from '../clean_build/contracts/PYLONLENDPool.json';
import COMPPoolJson from '../clean_build/contracts/PYLONCOMPPool.json';
import CRVPoolJson from '../clean_build/contracts/PYLONCRVPool.json';
import LINKPoolJson from '../clean_build/contracts/PYLONLINKPool.json';
import SNXPoolJson from '../clean_build/contracts/PYLONSNXPool.json';

import WBTCPoolJson from '../clean_build/contracts/PYLONBTCPool.json';
import YALINKPoolJson from '../clean_build/contracts/PYLONYALINKPool.json';

// uniswap pool
import IncJson from '../clean_build/contracts/PYLONIncentivizer.json';
...
export class Contracts {
  constructor(
    ...
    this.pylon = new this.web3.eth.Contract(PYLONJson.abi);
    ...
    this.rebaser = new this.web3.eth.Contract(PYLONRebaserJson.abi);
    this.reserves = new this.web3.eth.Contract(PYLONReservesJson.abi);
    this.gov = new this.web3.eth.Contract(PYLONGovJson.abi);
    this.timelock = new this.web3.eth.Contract(PYLONTimelockJson.abi);
  ...
  setProvider(
    ...
    this.pylon.setProvider(provider);
    ...
    const contracts = [
      { contract: this.pylon, json: PYLONJson },
      { contract: this.rebaser, json: PYLONRebaserJson },
      { contract: this.reserves, json: PYLONReservesJson },
      { contract: this.gov, json: PYLONGovJson },
      { contract: this.timelock, json: PYLONTimelockJson },
  ...
  setDefaultAccount(
    ...
    this.pylon.options.from = account;
